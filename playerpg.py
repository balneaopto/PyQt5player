...
from pygame import mixer    # In order to install PYGAME PYTHON3 see README.md and https://www.pygame.org/wiki/GettingStarted#Debian/Ubuntu/Mint
...
class FormWidget(QtWidgets.QWidget): 
      ...
      def play(self,mediafile):
          mixer.music.load(mediafile)  #  If a music stream is already playing it will be stopped. Not needed an explicit stop command.
          mixer.music.play()           ##
